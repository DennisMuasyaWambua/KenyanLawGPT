...
const (
	RetrievalService_Retrieve_FullMethodName = "/wakili.v1.RetrievalService/Retrieve"
)
...
type RetrievalServiceClient interface {
	...
	Retrieve(ctx context.Context, in *TenantScopedQuery, opts ...grpc.CallOption) (*RankedContext, error)
}
...
func (c *retrievalServiceClient) Retrieve(ctx context.Context, in *TenantScopedQuery, opts ...grpc.CallOption) (*RankedContext, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RankedContext)
...
type RetrievalServiceServer interface {
	// Hybrid pgvector + knowledge-graph retrieval over the shared public corpus
	// and the calling tenant's private partition only.
	Retrieve(context.Context, *TenantScopedQuery) (*RankedContext, error)
...
func (UnimplementedRetrievalServiceServer) Retrieve(context.Context, *TenantScopedQuery) (*RankedContext, error) {
...
func _RetrievalService_Retrieve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RetrievalServiceServer).Retrieve(ctx, req.(*TenantScopedQuery))
	}
...
var RetrievalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wakili.v1.RetrievalService",
	...
	Metadata: "wakili/v1/retrieval.proto",
}
